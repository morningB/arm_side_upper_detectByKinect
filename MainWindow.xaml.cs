...
namespace Microsoft.Samples.Kinect.SkeletonBasics
{
    ...
    public partial class MainWindow : Window
    {
        ...
        // 저장파일
        String filePath = "skeleton_data.csv";
        static StreamWriter fileWriter = new StreamWriter("skeleton_data.csv");
        ...
        {
            // 엑셀 파일 가로열 제목
            String exel_row_title = $"{"headX"},{"headY"},{"spineX"},{"spineY"},{"shoulder centerX"},{"shoulder centerX"},{"shoulder rightX"},{"shoulder rightY"},{"elbowRightX"},{"elbowRightY"},{"wristrightX"},{"wristrightY"},{"center angle"}";
            fileWriter.WriteLine(exel_row_title);
        ...
        // 백터 좌표 사이에 각 구하는 함수
        static private String third(float spineX, float spineY, float shoulderRightX, float shoulderRightY, float wristRightX, float wristRightY)
        {
            // 세 개의 좌표 A, B, C를 정의
            Point2D A = new Point2D(spineX, spineY);
            Point2D B = new Point2D(shoulderRightX, shoulderRightY);
        ...
        /// <returns></returns>
        private String SkeletonPointX(SkeletonPoint skelpoint)
        {
            DepthImagePoint depthPoint = this.sensor.CoordinateMapper.MapSkeletonPointToDepthPoint(skelpoint, DepthImageFormat.Resolution640x480Fps30);

            return  $"{depthPoint.X}";
        }
        private String SkeletonPointY(SkeletonPoint skelpoint)
        {
            DepthImagePoint depthPoint = this.sensor.CoordinateMapper.MapSkeletonPointToDepthPoint(skelpoint, DepthImageFormat.Resolution640x480Fps30);
